...
const NEMVAI_I18N = {
  en: {
    ...
    "habits.modalTitle": "Create New Habit — Detailed Setup",
    "habits.fieldTitle": "Habit Title",
    "habits.fieldTitlePlaceholder": "e.g., Morning Run",
    "habits.fieldDesc": "Description / What is this habit?",
    "habits.fieldDescPlaceholder": "Explain why this habit matters...",
    "habits.fieldFrequency": "Frequency per week",
    "habits.fieldFrequencyHelp": "How many days per week? (1-7)",
    "habits.fieldDuration": "Time per session (minutes)",
    "habits.fieldDurationHelp": "Minutes per session (5-480)",
    "habits.fieldTarget": "Target duration (months)",
    "habits.fieldTargetHelp": "How many months to track? (1-36)",
    "habits.confirm": "Confirm & Create",
  ...
  fr: {
    ...
    "habits.modalTitle": "Créer une habitude — Configuration détaillée",
    "habits.fieldTitle": "Titre de l'habitude",
    "habits.fieldTitlePlaceholder": "ex: Course matinale",
    "habits.fieldDesc": "Description / C'est quoi cette habitude ?",
    "habits.fieldDescPlaceholder": "Expliquez pourquoi...",
    "habits.fieldFrequency": "Fréquence par semaine",
    "habits.fieldFrequencyHelp": "Combien de jours par semaine ? (1-7)",
    "habits.fieldDuration": "Temps par séance (minutes)",
    "habits.fieldDurationHelp": "Minutes par séance (5-480)",
    "habits.fieldTarget": "Durée cible (mois)",
    "habits.fieldTargetHelp": "Combien de mois ? (1-36)",
    "habits.confirm": "Confirmer & Créer",
  ...
  ar: {
    ...
    "habits.modalTitle": "إنشاء عادة جديدة — إعداد مفصل",
    "habits.fieldTitle": "عنوان العادة",
    "habits.fieldTitlePlaceholder": "مثال: جري صباحي",
    "habits.fieldDesc": "الوصف / ما هي هذه العادة؟",
    "habits.fieldDescPlaceholder": "اشرح لماذا هذه العادة مهمة...",
    "habits.fieldFrequency": "التكرار في الأسبوع",
    "habits.fieldFrequencyHelp": "كم يوماً في الأسبوع؟ (1-7)",
    "habits.fieldDuration": "المدة لكل جلسة (دقائق)",
    "habits.fieldDurationHelp": "الدقائق لكل جلسة (5-480)",
    "habits.fieldTarget": "المدة المستهدفة (أشهر)",
    "habits.fieldTargetHelp": "كم شهراً للمتابعة؟ (1-36)",
    "habits.confirm": "تأكيد وإنشاء",
    "habits.cancel": "إلغاء",
